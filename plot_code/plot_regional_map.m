function plot_regional_map(trix,triy, maxWH_all,lat_boundary, lon_boundary, min_clr, max_clr, title_text, isxticklabel, isyticklabel,num_label)
axis equal

m_proj('miller','lat',lat_boundary,'lon',lon_boundary); % robinson Mollweide
...
m_text(lon_boundary(2)-0.07,lat_boundary(1)+0.04,num_label,'fontsize',20,'fontweight','bold');
%colorbar
