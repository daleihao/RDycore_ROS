...
% Show R² and RMSE
text(0.5, 10*0.96, sprintf('R^2 = %.2f', R2), 'FontSize', 20, 'VerticalAlignment', 'top');
text(0.5, 10*0.85, sprintf('RMSE = %.2f m', RMSE), 'FontSize', 20, 'VerticalAlignment', 'top');
...
exportgraphics(gcf, 'RF_modeling_RMSE_r.tiff', 'Resolution', 300);
hold off;
close all;
